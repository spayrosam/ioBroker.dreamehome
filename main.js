...
const DreameWaterVolume = Object.fromEntries(Waterstr.replace(/,.$/, '').split(',').map(i => i.split(':')));
...
class Dreame extends utils.Adapter {
        ...
        */
            ...
            "hash": "54587b0364cdd763deba93a974ef5aa05cbe7dcc"
                    ...
                    this.json2iob.parse(device.did + '.general', device, {
                        states: {
                            latestStatus: this.states[device.did]
                        },
    ...
    async fetchSpecs() {
        ...
        const specs = [];
        for (const device of this.deviceArray) {
            const type = allDevices.data.instances.filter((obj) => {
            ...
            if (type.length === 0) {
                ...
                type[0] = 'urn:miot-spec-v2:device:vacuum:0000A006:dreame-r2253:1'; //'urn:miot-spec-v2:device:vacuum:0000A006:dreame-r2320:1';//
                //https://miot-spec.org/miot-spec-v2/instance?type=urn:miot-spec-v2:device:vacuum:0000A006:dreame-r2253:1
            }
    ...
    */
    ...
    async UpdateRoomSettings(RoomInd, ChangeType, ChangeVal) {
        ...
        var stateSuctionLevel, stateWaterVolume, stateRepeats, stateCleaningMode, stateRoute, stateSuctionLevelOb, stateWaterVolumeOb, stateRepeatsOb, stateCleaningModeOb, stateRouteOb;
                    ...
                    if (id.split('.')[5] === 'Start-Clean') {
                        ...
                        if (GetCleanChange) {
                            try {
                                ...
                                var GetRoomIdOb, GetRoomId, GetRepeatsOb, GetRepeats, GetSuctionLevelOb, GetSuctionLevel, GetWaterVolumeOb, GetWaterVolume;
                                var GetMultiId = 0;
